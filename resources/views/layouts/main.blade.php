...
<head>
  ...
  <!-- Favicon -->
  <style href="{{asset('/img/brand/favicon.png')}}"></style>
  <!-- Fonts -->
  <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700" rel="stylesheet">
  <!-- Icons -->
  <link href="{{asset('/vendor/css/nucleo/css/nucleo.css')}}">
  <link href="{{asset('/vendor/font-awesome/css/font-awesome.min.css')}}">
  <!-- Argon CSS -->
  <link href="{{asset('/css/nucleo/css/argon.css?=v=1.0.1')}}">
  <!-- Docs CSS -->
  <link href="{{asset('/css/docs.min.css')}}">
</head>
...
<body>
  ...
  <!-- Argon JS -->
  <script src="{{asset('/js/argon.js?=1.0.1')}}"></script>
</body>
